...
export interface Env extends Cloudflare.Env {
  // Authoritative exact RFC 822 source for every accepted inbound message.
  RAW_MAIL_BUCKET: R2Bucket;
  // Durable pointer handoff from SMTP ingress to idempotent Mailbox projection.
  ...
  JWT_SECRET: string;
  // Verified external destination used only after raw archive and Mailbox failure.
