...
const ENVIRONMENTS = {
	whispyr: {
		...
		forbidden: [
			...
			"wiserchat.ai",
			"marquista-mail-portal",
			"marquista-mail-portal-preview",
			"marquista_mail_portal_users",
			"bccae6f0-05d2-48d6-b05f-309f0fcf6c24",
			"f7f21d5e98ff48fc976b5542c3501adf",
			"marquista-mail-raw-archive",
			"marquista-mail-inbound",
			"marquista-mail-emergency-forward",
			"emergency-forward@marquista.co",
			"marquista.co",
		],
	},
	wiser: {
	...
	marquista: {
		...
		brand: "marquista",
		domains: "marquista.co",
		features: [],
		databaseName: "marquista_mail_portal_users",
		databaseId: "bccae6f0-05d2-48d6-b05f-309f0fcf6c24",
		attachmentBucket: "marquista-mail-portal",
		attachmentPreviewBucket: "marquista-mail-portal-preview",
		rawBucket: "marquista-mail-raw-archive",
		rawPreviewBucket: "marquista-mail-raw-archive-preview",
		inboundQueue: "marquista-mail-inbound",
		inboundDlq: "marquista-mail-inbound-dlq",
		inboundParking: "marquista-mail-inbound-parking",
